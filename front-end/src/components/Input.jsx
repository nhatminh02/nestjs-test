...
const Input = ({
  ...
  return (
    <div className="my-2 flex items-center justify-center rounded-sm border-2">
      <input
        name={name}
        type={type}
        value={value}
        ...
        className="w-full border-none px-2 py-1 outline-none"
      />
      {name === "password" && (
        <div
          className="flex cursor-pointer select-none items-center justify-center px-2"
          onClick={handleShowPassword}
        >
          {type === "password" ? (
            <svg fill="none" viewBox="0 0 20 10" className="mt-2 h-5 w-5">
              <path
                stroke="none"
                fill="#000"
